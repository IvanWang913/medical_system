...
?>
  <tr>
    ...
    <td align="center"><a href="staff_doctor_update.php?ICNo=<?php echo $row['ICNo'];?>">Update</a>
    <td align="center"><a href="staff_doctor_delete.php?ICNo=<?php echo $row['ICNo'];?>"onclick="return checkdelete()">Delete</a></td>
  </tr>
<?php 
}
?>
